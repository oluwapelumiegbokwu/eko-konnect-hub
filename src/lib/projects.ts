...
export const projects: Project[] = [
  {
    slug: "gaf-demonstrator-project",
    title: "Global Access Fund (GAF) Demonstrator Project",
    href: "https://datacite.org/global-access-fund/#GAF-awardees",
    body: "Eko-Konnect collaborated with the National Commission of Museums and Monuments (NCMM), under the Federal Ministry of Arts, Culture & Creative Economy, to advance the Global Access Fund (GAF) Demonstrator Project. The project's objective is to digitize Nigeria's archaeological artefacts and historical objects, ensuring their long-term accessibility in Open Access Repositories. This initiative supports the broader goal of enhancing cultural heritage preservation while promoting Open Science and Open Access practices.",
  },
  {
    slug: "national-repository-of-nigeria",
