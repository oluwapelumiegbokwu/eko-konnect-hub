...
export const Route = createFileRoute("/media/blog")({
  head: () => ({
    meta: [
      { title: "Blog Posts | Eko-Konnect" },
      {
        name: "description",
        content: "Blog posts from Eko-Konnect Research and Education Initiative.",
      },
      { property: "og:title", content: "Blog Posts | Eko-Konnect" },
    ],
  }),
  component: Blog,
});
...
function Blog() {
  return (
    <>
      <PageHeader eyebrow="Media" title="Blog Posts" />
